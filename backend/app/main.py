...
app=FastAPI(title="IntegrityLens Pro v2.3 API",version="2.3.0")
...
@app.get("/")
def root():return {"ok":True,"message":"IntegrityLens Pro v2.3 API is running","version":"2.3.0"}
@app.get("/health")
def health():return {"ok":True,"version":"2.3.0"}
